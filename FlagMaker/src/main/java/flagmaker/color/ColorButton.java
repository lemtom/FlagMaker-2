...
public class ColorButton extends VBox {
	...
	private Color value;
	private flagmaker.MainWindowController mainWindowController;
	private Stage stage;
	...
	private void onClicked() {
		...
		ColorSelector control = new ColorSelector(dialog, value,
				new ArrayList<>(Arrays.asList(mainWindowController.flag().colorsUsed())),
				mainWindowController.recentColors);
