...
public class OverlayBox extends OverlayShape {
	...
	protected Shape[] thumbnail() {
		return new Shape[] { new Rectangle(5, 7.5, 20, 15) };
	}
	...
	public String exportSvg(int width, int height) {
		...
		return String.format(Locale.US, "<rect width=\"%.3f\" height=\"%.3f\" x=\"%.3f\" y=\"%.3f\" %s />", w, h,
				width * (getDoubleAttribute("X") / maximumX), height * (getDoubleAttribute("Y") / maximumY),
