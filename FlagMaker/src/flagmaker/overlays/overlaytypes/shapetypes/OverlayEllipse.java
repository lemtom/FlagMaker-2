...
public class OverlayEllipse extends OverlayShape {
	...
	protected Shape[] thumbnail() {
		return new Shape[] { new Ellipse(15, 15, 15, 10) };
	}
	...
	public String exportSvg(int width, int height) {
		...
		return String.format(Locale.US, "<ellipse cx=\"%.3f\" cy=\"%.3f\" rx=\"%.3f\" ry=\"%.3f\" %s />", x, y, w / 2,
				h / 2, ColorExtensions.toSvgFillWithOpacity(getColorAttribute("Color")));
	}
}
