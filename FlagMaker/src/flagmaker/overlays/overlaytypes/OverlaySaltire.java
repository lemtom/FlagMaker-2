...
public class OverlaySaltire extends Overlay {
	public OverlaySaltire(int maximumX, int maximumY) {
		super("saltire", new Attribute[] { new ColorAttribute("Color", Color.BLACK),
	...
	public OverlaySaltire(Color color, double thickness, int maximumX, int maximumY) {
		super("saltire", new Attribute[] { new ColorAttribute("Color", color),
	...
	public void draw(Pane canvas) {
		...
		path1.setContent(String.format(Locale.US,
				"M %1$.3f,0 0,0 0,%2$.3f %3$.3f,%4$.3f %5$.3f,%4$.3f %5$.3f,%6$.3f %1$.3f,0", widthX, widthY,
				canvas.getWidth() - widthX, canvas.getHeight(), canvas.getWidth(), canvas.getHeight() - widthY));
		path2.setContent(
				String.format(Locale.US, "M %1$.3f,0 %2$.3f,0 %2$.3f,%6$.3f %3$.3f,%4$.3f 0,%4$.3f 0,%5$.3f %1$.3f,0",
						canvas.getWidth() - widthX, canvas.getWidth(), widthX, canvas.getHeight(),
						canvas.getHeight() - widthY, widthY));
	...
	public String exportSvg(int width, int height) {
		...
		return String.format(Locale.US,
				"<polygon points=\"%1$.3f,0 0,0 0,%6$.3f %2$.3f,%3$d %4$d,%3$d %4$d,%5$.3f %1$.3f,0\" %7$s /><polygon points=\"%2$.3f,0 %4$d,0 %4$d,%6$.3f %1$.3f,%3$d 0,%3$d 0,%5$.3f %2$.3f,0\" %7$s />",
