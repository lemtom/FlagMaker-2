...
public class ColorSelector extends VBox {
	...
	@FXML
	private Label labelFotw;
	@FXML
	private FlowPane paneFotw;
	@FXML
	private Label labelFoan;
	@FXML
	private FlowPane paneFoan;
	@FXML
	private Label labelRecent;
	@FXML
	private FlowPane paneRecent;
	@FXML
	private Label labelUsed;
	@FXML
	private FlowPane paneUsed;
	...
	private Label lblA;
	@FXML
	private Button btnSaveAdvanced;
	@FXML
	private Canvas cnvSatLight;
	@FXML
	private Canvas cnvHue;
	@FXML
	private Rectangle rctPreview;

	@FXML
	private Button btnCancelStandard;
	@FXML
	private Button btnCancelAdvanced;
	...
	private void fillNamedColorList(FlowPane pane, List<NamedColor> colors) {
	...
	@FXML
	private void cnvSatLightDrag(MouseEvent e) {
		shouldTrigger = false;
	...
	@FXML
	private void cnvHueDrag(MouseEvent e) {
		shouldTrigger = false;
	...
	private void setColorFromSliders() {
		tempColor = new Color(sldR.getValue() / 255, sldG.getValue() / 255, sldB.getValue() / 255,
				sldA.getValue() / 255);
	}
