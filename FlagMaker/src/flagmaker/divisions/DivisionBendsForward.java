...
public class DivisionBendsForward extends Division {
	...
	public void draw(Pane canvas) {
		...
		Path p = new Path(new PathElement[] { new MoveTo(width, 0), new LineTo(width, height), new LineTo(0, height),
				new LineTo(width, 0) });
	...
	public String exportSvg(int width, int height) {
		...
		sb.append(String.format("<polygon points=\"%1$d,%2$d %1$d,0 0,%2$d\" %3$s />", width, height,
